...
const commandData = (guildId) => __awaiter(void 0, void 0, void 0, function* () {
    const query = yield prisma_1.default.commands.findUnique({
        where: {
            guild_id: guildId,
        },
    });
...
//# sourceMappingURL=commandsData.js.map