const Privacy = () => (
  <div className="p-10 space-y-5">
    <div className="text-2xl font-bold">Privacy Policy of xellx.co.vu</div>
    <div>This Website collects some Personal Data from its Users.</div>
    ...
    <div>Owner contact email: zeloeee@gmail.com</div>
    <div>
      Types of Data collected Among the types of Personal Data that this Website
      collects, by itself or through third parties, there are: Cookies; Usage
    ...
    <div>
      ...
      texts displayed prior to the Data collection. Personal Data may be freely
      provided by the User, or, in case of Usage Data, collected automatically
      when using this Website. Unless specified otherwise, all Data requested by
      this Website is mandatory and failure to provide this Data may make it
      impossible for this Website to provide its services. In cases where this
      Website specifically states that some Data is not mandatory, Users are
      free not to communicate this Data without consequences to the availability
      or the functioning of the Service. Users who are uncertain about which
      Personal Data is mandatory are welcome to contact the Owner. Any use of
      Cookies – or of other tracking tools – by this Website or by the owners of
      third-party services used by this Website serves the purpose of providing
    ...
    <div>
      ...
      operation of this Website (administration, system administration). The
      updated list of these parties may be requested from the Owner at any time.
    </div>
    <div>
      Legal basis of processing The Owner may process Personal Data relating to
    ...
    <div>
      ...
      European data protection law; provision of Data is necessary for the
      performance of an agreement with the User and/or for any pre-contractual
      obligations thereof; processing is necessary for compliance with a legal
      obligation to which the Owner is subject; processing is related to a task
    ...
    <div>
      Retention time Personal Data shall be processed and stored for as long as
    ...
    <div>The purposes of processing</div>
    <div>
      ...
      requests, protect its rights and interests (or those of its Users), detect
      any malicious or fraudulent activity, as well as the following: Analytics,
      Traffic optimization and distribution, Displaying content from external
      platforms, Infrastructure monitoring, Handling payments, Social features,
      Hosting and backend infrastructure and Registration and authentication.
    </div>
    <div>
